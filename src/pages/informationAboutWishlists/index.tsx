            ...
            <div className={styles.description}>
              <section>
                ...
                <p>
                  ...
                  товаров или услуг, которые человек хочет получить в подарок
                  или приобрести в будущем. Эти списки можно составлять для
                  различных поводов: дни рождения, свадьбы, праздники или просто
              ...
              <section>
                ...
                <ul>
                  <li>
                    ...
                    значительно облегчают задачу выбора подарка для ваших друзей
                    и близких. Вместо того чтобы гадать, что именно порадует
                  ...
                  <li>
                    ...
                    существует риск дублирования. Вишлист позволяет избежать
                    таких ситуаций, так как каждый может видеть, что уже
                    куплено, а что еще нет.
                  </li>
                  <li>
                    <strong>Экономия времени и сил:</strong> Составление и
                    использование вишлиста экономит время и усилия как для
                    дарящего, так и для получателя. Дарящему не нужно тратить
                    часы на поиски подходящего подарка, а получатель может быть
                    уверен, что получит именно то, что ему нужно или хочется.
                  </li>
                  <li>
                    <strong>Учет предпочтений:</strong> Вишлисты помогают учесть
                    индивидуальные предпочтения и вкусы. Это особенно важно,
                    когда вы не слишком близко знакомы с человеком, но хотите
                    сделать приятное. Просто ознакомьтесь с его вишлистом, и вы
                    точно не ошибетесь с выбором.
                  </li>
                  <li>
                    <strong>Планирование покупок:</strong> Вишлисты удобны не
                    только для подарков, но и для личного планирования покупок.
                    С их помощью можно отслеживать нужные товары и услуги,
